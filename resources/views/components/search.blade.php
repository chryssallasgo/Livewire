<div class="mb-4 ">
    <div class="relative">
      <input {{ $attributes }} type="email" class="block w-full px-4 py-3 text-sm bg-blue-100 rounded-lg border-grey-300 peer ps-11 focus:border-blue-500 focus:ring-sky-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-blue-900 dark:border-transparent dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
