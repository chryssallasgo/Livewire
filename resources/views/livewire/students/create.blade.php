                    ...
                    <div class="flex flex-col gap-y-4">
                        ...
                        <form wire:submit='addStudent'>
                            ...
                            <div class="flex justify-end mt-4 gap-x-3">
                                <a href="{{ route('students.index') }}" class="inline-flex items-center px-4 py-3 text-sm font-medium border border-transparent rounded-lg text-emerald-100 bg-emerald-900 gap-x-2 hover:bg-indigo-200 focus:outline-none focus:bg-indigo-200 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-emerald-600 dark:focus:bg-emerald-900">
                                    Cancel
                                </a>
