  ...
  <div class="py-4">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div class="flex justify-between p-4 item-center">
             ...
             <div>
              <a href="{{ route('students.create') }}" wire:navigate class="inline-flex items-center px-4 py-3 mb-4 text-sm font-medium text-white border border-transparent rounded-lg shadow-md bg-emerald-500 gap-x-2 hover:bg-emerald-600 focus:outline-none focus:bg-emerald-600 disabled:opacity-50 disabled:pointer-events-none">
                  Add Student
              </a>
             </div>
          </div>
                      ...
                      <div class="-m-1.5 overflow-x-auto">
                        <div class="p-1.5 min-w-full inline-block align-middle">
                          <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-green-200 dark:divide-green-700" id="paginated-students">
                              <thead>
                                <tr>
                                  <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start dark:text-emerald-500">ID</th>
                                  <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start dark:text-emerald-500">Name</th>
                                  <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start dark:text-emerald-500">Email</th>
                                  <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start dark:text-emerald-500">Class</th>
                                  <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-start dark:text-emerald-500">Section</th>
                                  <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase text-end dark:text-emerald-500">Action</th>
                                </tr>
                              </thead>
                              <tbody>
